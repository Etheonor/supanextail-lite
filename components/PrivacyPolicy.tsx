const PrivacyPolicy = (): JSX.Element => (
  <div className="max-w-xl py-10 m-auto text-left">
    <h1 className="text-center">Privacy Policy for SupaNexTail</h1>

    <p>
      At SupaNexTail, accessible from https://www.supanextail.dev, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      SupaNexTail and how we use it.
    </p>
    ...
    <p>
      SupaNexTail legal basis for collecting and using the personal information
    ...
    <ul>
      <li>SupaNexTail needs to perform a contract with you</li>
      <li>You have given SupaNexTail permission to do so</li>
      <li>
        Processing your personal information is in SupaNexTail legitimate
        interests
      </li>
      <li>SupaNexTail needs to comply with the law</li>
    </ul>

    <p>
      SupaNexTail will retain your personal information only for as long as is
    ...
    <p>
      SupaNexTail follows a standard procedure of using log files. These files
    ...
    <p>
      ...
      advertising partners of SupaNexTail.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on SupaNexTail, which are sent
    ...
    <p>
      Note that SupaNexTail has no access to or control over these cookies that
    ...
    <p>
      SupaNexTail's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      SupaNexTail does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in SupaNexTail. This policy is not applicable to any
