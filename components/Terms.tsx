const Terms = (): JSX.Element => (
  <div className="max-w-xl py-10 m-auto text-left">
    ...
    <p>
      ...
      <span className="website_name">SupaNexTail</span>, because by using the
      Website you accept and agree to be bound and abide by these Terms and
      Conditions.
    </p>
    ...
    <p>
      ...
      <span className="website_name">SupaNexTail</span>.
    </p>
    ...
    <p>
      Your use of <span className="website_name">SupaNexTail</span> is at your
      sole risk. The Website is provided "as is" and "as available". We disclaim
    ...
    <p>
      ...
      you create a <span className="website_name">SupaNexTail</span> account or
      when you start using the <span className="website_name">SupaNexTail</span>{' '}
      and will remain effective until terminated by you or by us.{' '}
    </p>

    <p>
      <span className="website_name">SupaNexTail</span> reserves the right to
      terminate this Terms and Conditions or suspend your account at any time in
      case of unauthorized, or suspected unauthorized use of the Website whether
      in contravention of this Terms and Conditions or otherwise. If{' '}
      <span className="website_name">SupaNexTail</span> terminates this Terms
      and Conditions, or suspends your account for any of the reasons set out in
      this section, <span className="website_name">SupaNexTail</span> shall have
      no liability or responsibility to you.
    </p>

    <h2>Assignment</h2>

    <p>
      <span className="website_name">SupaNexTail</span> may assign this Terms
      and Conditions or any part of it without restrictions. You may not assign
      this Terms and Conditions or any part of it to any third party.
    </p>
